...
uses Dialogs,
     Classes, Types, SysUtils, Controls, Graphics, ExtCtrls, StrUtils, IdGlobal, IdGlobalProtocols,
     Windows,Forms,
     uKey, uTrial, uLibrary, uCounterManager, uCounter, uConstants;
...
procedure TSimpl.Dispenser(Csq: Byte; Usb: ShortInt);
begin

...
uses Dialogs,
     ...
     Registry, StdCtrls, ExtCtrls, ShellAnimations, OleCtrls, JPEG,
     uSchMan, uCounter, JvExControls, JvAnimatedImage, JvGIFCtrl, WMPLib_TLB;
...
type
  ...
  private
    ...
    //procedure MPlayerLoopNotify (Sender : TObject);
...
begin
  if FileExists(Self.FullPath) then
    begin
...
begin
  if Assigned(OnConsequence2) then FOnConsequence2 (Self);    //Necessariamente Self
end;

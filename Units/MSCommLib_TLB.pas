...
// $Rev: 41960 $
// File generated on 11/19/2012 1:59:50 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Windows\SysWow64\mscomm32.ocx (1)
// LIBID: {648A5603-2C6E-101B-82B6-000000000014}
// LCID: 0
// Helpfile: C:\Windows\SysWow64\COMM98.CHM
...
begin
  ...
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnComm) - UIntPtr(Self);
end;
...
begin
  DefaultInterface.Output := pvarOutput;
end;
...
begin
  DefaultInterface.Input := pvarInput;
end;
